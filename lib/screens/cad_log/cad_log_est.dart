...
import 'package:petsguide/main.dart';
import 'package:petsguide/screens/cad_log/cad_log_user.dart';
import 'package:petsguide/screens/termos_de_uso.dart';
import 'package:petsguide/servicos/firebase_options.dart';
import 'package:petsguide/snackbar/snack_bar.dart';
import 'package:petsguide/servicos/auth_svc.dart';
import 'package:petsguide/style/style.dart';
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (agree == false) {
                              return 'Você precisa estar de acordo com os termos de uso';
                            }
                            return null;
                          },
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Text('Eu li e concordo com os'),
                            Expanded(
                              child: TextButton(
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => const Consentimento(),));
                                },
                                child: const Text(
