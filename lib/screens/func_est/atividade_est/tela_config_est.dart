...
import 'package:petsguide/screens/func_est/atividade_est/tela_reset_senha_est.dart';
            ...
            ? Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title: const Text('Termos de Uso de Dados'),
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const Consentimento(),
                          ));
                    },
                  )
                ],
